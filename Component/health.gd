...
""" needs to understand what this code does before moving on """

signal max_health_change(diff : int)
...
# setter and getter for max_health
...
# setter and getter for immortality
